...
private:
    ...
    static constexpr std::string_view p1{ "login0" }; // login0x.tibia.com
    static constexpr std::string_view p2 { "cipsoft." }; // tibia0x.cipsoft.com
...
public:
    ...
    {
        SearchAndReplace(buffer, p1, ip);
        SearchAndReplace(buffer, p2, ip);
